...
public class OnStartRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        categoryDto_1.setId(2L);
        categoryDto_1.setName("Adventure");
        categoryService.saveCategoryFromDTO(categoryDto_2);

        CategoryDto categoryDto_3 = new CategoryDto();
        categoryDto_1.setId(3L);
        categoryDto_1.setName("Drama");
        ...
        bookService.saveBookFromDTO(bookDTO1,categoryDto_1);
        ...
        bookService.saveBookFromDTO(bookDTO2,categoryDto_2);
        ...
        bookService.saveBookFromDTO(bookDTO3,categoryDto_3);
